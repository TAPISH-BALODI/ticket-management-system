  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav" style={{marginLeft:"auto"}}>
      <li class="nav-item dropdown">
        ...
        <li class="nav-item ">
          <a href="home" target="_blank" class="nav-link apply-button d-none d-sm-block">Apply now</a>
      </li>
...
<div class="col-lg-7 col-12"  data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1400">
 ...
 <a href={`${process.env.REACT_APP_B2B}`} class="nav-link apply-button w-25 text-center p-3 fs-5">Login</a>
</div>
